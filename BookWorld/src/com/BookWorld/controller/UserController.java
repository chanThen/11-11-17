...
public class UserController {
	...
	public String authUserByEmail( User userEnteredCredentials) throws Exception
	{
		...
		//byte[] emailAsBytes = Base64.getDecoder().decode(user.getEmail());
		//String decryptedEmail = new String(emailAsBytes);
		
		//byte[] passwordAsBytes = Base64.getDecoder().decode(user.getPwd());
		
		//String decryptedPassword = new String(passwordAsBytes);
